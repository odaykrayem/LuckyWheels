...
public class OneMinuteCountDownService  extends Service {

        public static final String BROADCAST_ACTION = "com.example.luckywheels.Services.oneminte";
        private Intent intent = new Intent(BROADCAST_ACTION);
        private String TAG = "BroadcastService";
        private Handler handler = new Handler();
        //    private long initial_time;
        private static final long START_TIME_IN_MILLIS = Constants.TIMER_ONE_M;
